...
extern const std::vector<SceneDB::Init> sceneDBInit{
    { // SCENE_DEKU_TREE
        ...
        {},
        {
            ...
            {
                { F_NA,  9999.0f, { }, std::string{}, std::string{}, {}, {}, },
                { F_NA,  9999.0f, { }, std::string{}, std::string{}, {}, {}, },
                { F_NA,  9999.0f, { }, std::string{}, std::string{}, {}, {}, },
    ...
    { // The entrance table has an entrance for a scene that does not exist. This entry makes a scene that they can be accounted to it.
        "SCENE_UNUSED_6E",
