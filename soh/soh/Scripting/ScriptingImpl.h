...
enum class ScriptLanguage { Python };
...
class IScriptImplementation {
  public:
    ...
    virtual void CreateActorInstanceData(Actor* actor, size_t size) = 0; // TODO remove size?
    virtual void DeleteActorInstanceData(Actor* actor) = 0;
